...
| Project | Commit | Role |
| --- | --- | --- |
| DeepSeek Harness | `b150a551b8d465e31e418e1b2eaf5e79bbb7d28e` (`dsh-v0.1.1-rc.2`, official upstream commit) | Read-only runtime source; exported to a disposable build copy and packaged by SeekDock. |
